...
* **Explainable Security:** Generates a **JSON Security Envelope** for every interaction, providing a detailed audit trail of *why* a command was blocked (e.g., "Blocked by Deterministic Guard: Coolant Flow 0%").
